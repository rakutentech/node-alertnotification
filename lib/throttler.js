...
exports.throttleError = async(err) => {
    ...
    await cache.set(err.toString(), todayDatetime.toString()).then(function() {
...
getThrottlingDuration = () => {
    ...
    throttlingDuration = throttlingDuration * 60 * 1000;
...
exports.isThrottled = async(err) => {
    ...
    if (cacheEntry.isCached) {
        ...
        duration = currentTime - cachedTime
            // passed throttling duration => send alert again.
